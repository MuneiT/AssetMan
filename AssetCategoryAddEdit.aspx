<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetCategoryAddEdit.aspx.cs" Inherits="AssetManagement.AssetCategoryAddEdit" %>
                ...
                <table style="padding-top:5px;">
                  ...
                  <tr>
                    ...
                    <td align="left" class="txt_blue_cgothic_13"><strong>CATEGORY:</strong></td>
                        <td align="left" class="txt_blue_cgothic_13">
                    <asp:TextBox ID="f_CatDesc" runat="server" 
